        ...
        return (
            <div className='container box bg-light px-5 py-5'>
                ...
                <h5 className=''>Центр паллиативной помощи</h5>
                        ...
                        <p className='my-2'>Центр паллиативной помощи « Я с тобой» принял первых детей на медицинскую, психологическую поддержку. Самому маленькому нашему пациенту нет и года, но им очень нравится в Центре, здесь они мужественно преодолевают 
свой диагноз и учатся жить дальше!
</p>
<br />
                        <p className='my-2'>В Центре дети находятся без родителей, это учит их быть самостоятельными, мамы и папы получают психологическую передышку! Дети из социальных семей нуждаются в одежде, обуви, лекарствах, памперсах, очень нужно питание для самой маленькой пациентки, у нее опухоль почки, смесь "Similac"для маловесных и недоношенных детей! Вы можете помочь через наш сайт в разделе "Как помочь".
</p>
